...
// The trading "agent orchestrator" already reads Claude usage for the active
...
const INDEX_PATH =
  ...
  "C:\\Users\\theke\\.claude\\agent-orchestrator\\accounts\\index.json";
const CACHE_PATH =
...
/** Best-available usage per account NAME (lowercased: "personal" / "vota"). */
