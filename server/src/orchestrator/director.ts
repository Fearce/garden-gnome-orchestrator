...
/**
 * The single long-lived Sonnet session Kevin chats with. Streaming-input mode
...
export class Director {
  ...
  handleUserMessage(text: string, workspaceHint?: string, images?: ImageAttachment[]): void {
    ...
    if (live && accountCapped) {
      ...
      // headroom (resume keeps the conversation) BEFORE sending, so Kevin never sees the
