...
A single director's console for running Claude Code agents the way Kevin already
...
> Not to be confused with the trading-fleet "agent orchestrator". This is the
...
- **Researcher — optional, external-only.** Web search, library/API docs, GitHub
  issues, changelogs, plus Kevin's memory. It does **not** read the codebase
