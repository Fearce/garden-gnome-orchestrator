...
console + fixture repo), `tablet-lab.cjs` (both tablet orientations in a TOUCH context) and
`model-select-lab.cjs` (a Settings toggle's round-trip + a server-fed table). Never against live prod.
